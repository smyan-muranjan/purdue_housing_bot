"""This module contains the PurdueHousingBot class which is a GUI application"""
...
class PurdueHousingBot:
    """This class is the Purdue Housing Bot GUI application"""
    email_re: str = (
        r"(?:[a-z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+\/=?^_`{|}~-]+)"
    ...
    def __init__(self, master: tk.Tk):
        ...
        self.is_running = tk.BooleanVar(self.window, value=False)
    ...
    def create_widgets(self):
        """Function creating the widgets for the GUI"""
    ...
    def validate_tesseract_location(self):
        """Function to validate the tesseract location"""
    ...
    def validate_inputs(self) -> bool:
        ...
        if (not valid_sender_email
            ...
            or not valid_reciever_emails
            or not valid_tesseract_location):
            return False
        error_message = (
    ...
    def check_screen(self):
        """Function to check the screen for available housing"""
        expected_output = "We couldn't find any available rooms."
        result = self.screen_to_string()
        print(result)
        if result is not None and expected_output not in result:
            self.send_email(
    ...
    def screen_to_string(self) -> str | None:
        """Function to convert the screen to a string"""
        try:
    ...
    def reset_message(self):
        """Function to reset the message label"""
        self.message.set("Not Running.")
...
if __name__ == "__main__":
    root = tk.Tk()
    app = PurdueHousingBot(master=root)
    root.mainloop()
